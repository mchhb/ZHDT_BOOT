...
//#define input1	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_9)
//#define input2	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_6)
#define input3	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_8)
#define input4	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_7)
#define input5	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_5)
#define input6	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_4)
