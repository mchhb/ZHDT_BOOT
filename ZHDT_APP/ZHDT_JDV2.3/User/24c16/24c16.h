...
#define EE_ADDR_DNS_TWO						0x51
#define EE_ADDR_DNS_THREE					0x52
#define EE_ADDR_DNS_FOUR					0x53
//------------------------------------端口
...
//------------------------------------w5500 config
#define EE_ADDR_REBOOT_SUM 								0x38
#define EE_ADDR_W5500_CONFIG_DHCP_IP			0x72
#define EE_ADDR_W5500_CONFIG_MAC					0x74
#define EE_ADDR_W5500_CONFIG_PORT					0x76
#define EE_ADDR_W5500_CONFIG_IP						0x78
#define EE_ADDR_REBOOT										0x80
#define EE_ADDR_DOOR_CLOSE_TIMES					0x82
#define EE_ADDR_DOOR_CLOSE_TIMES_SUM			0x84
#define EE_ADDR_DOOR_CLOSE_TIMES_SUM1			0x86
#define EE_ADDR_DOOR_CLOSE_TIMES_SUM2			0x88
#define EE_ADDR_MQTT_SEND_TIME						0x90
#define EE_ADDR_W5500_PC_CONFIG_SUCCESS     0x01
#define EE_ADDR_W5500_RAM_CONFIG_SUCCESS			0x02

#define EE_ADDR_IP_SUM 								0x96

#define EE_APP_CHECK				0x54
#define EE_APP_VERSION1			0x55
#define EE_APP_VERSION2			0x56
