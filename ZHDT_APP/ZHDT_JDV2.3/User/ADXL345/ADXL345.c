...
void ADXL345_init(void)
{
   ...
   ADXL345_write_byte(0x2C,0x0F); //输出速率  3200HZ   带宽1600   312us 一次。
   ADXL345_write_byte(0x2D,0x08); //测量模式
   ADXL345_write_byte(0x2E,0x80); //关闭中断  静止   
   ADXL345_write_byte(0x31,0X08); //±2g  
